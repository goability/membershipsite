...
//  a current $this object of type $WarehouseBaseType is required
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#manage"><?php echo $this->FormTitle; ?></a>
  </li>
</ul>

<div class="tab-content">
  <div class="tab-pane container active" id="manage">
        <?php include("formItemRecordGeneric.php");?>
  </div>
</div>
